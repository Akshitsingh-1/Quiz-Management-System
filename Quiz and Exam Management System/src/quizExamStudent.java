...
public void answerCheck()
{
    ...
    //clear jRadioButton                                       //Written at last
    ...
    //last question hide next buttton
...
public void submit()
{
    ...
    public quizExamStudent(String rollNo)
    {
        ...
        try
        {
            ...
            while(rs1.next())
            {
                ...
                jRadioButton3.setText(rs1.getString(5));
                jRadioButton4.setText(rs1.getString(6));
                answer=rs1.getString(7);                             //we are inserting 7th column here
        ...
        time=new Timer(1000, new ActionListener(){
                    ...
                    if(sec==60)
                    {
                           ...
                           if(min==10)
                            {
                                time.stop();
                                answerCheck();                         //These two will be executed if time reached to 10 Minutes
                                submit();
                            }
                    }
                    sec++;
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 70, -1, 700));

        jLabel20.setFont(new java.awt.Font("Tahoma", 1, 20)); // NOI18N
        jLabel20.setText("Question Demo?");
        getContentPane().add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 140, -1, -1));
        ...
        getContentPane().add(jRadioButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 220, -1, -1));
        ...
        getContentPane().add(jRadioButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 320, -1, -1));
        ...
        getContentPane().add(jRadioButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 410, -1, -1));
        ...
        getContentPane().add(jRadioButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 510, -1, -1));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 660, -1, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1050, 660, -1, -1));
