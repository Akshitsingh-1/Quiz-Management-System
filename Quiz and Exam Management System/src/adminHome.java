...
public class adminHome extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -10, 1440, 750));
        ...
        jMenu2.setText("Update New Question");
        ...
        jMenu7.setMargin(new java.awt.Insets(3, 5, 3, 30));
    ...
    private void jMenu6MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu6MouseClicked
        ...
        jf.setAlwaysOnTop(true);              //Get Hided on back thats why we Are using this on Top
    ...
    private void jMenu3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jMenu3MouseClicked
        ...
        if(open==0)
        {
            new allQuestion().setVisible(true);            //Now this is Connected to all Questions
            open=1;
        }
        else
        {
